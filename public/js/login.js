...
async function handleChange() {
    const username = document.querySelector("#change-username")?.value;
    const oldpassword = document.querySelector("#change-oldpassword")?.value;
    const newpassword = document.querySelector("#change-newpassword")?.value;
